...
public class MapView extends View
{
    ...
    private List<PointF> userPath2 = new ArrayList<PointF>();
    ...
    private static final int USER_PATH2_COLOR_INDEX = 6;
     ...
     */
    public void setHeadingPath(List<PointF> points)
    {
        userPath.clear();
    ...
    public void setUserPath2(List<PointF> points)
    {
        userPath2.clear();
        
        if(points != null)
            userPath2.addAll(points);
    ...
    protected void onDraw(Canvas canvas){
        ...
        for(int i = 0; i < userPath2.size() - 1; i++){
            canvas.drawLine(userPath2.get(i).x * scale.x, userPath2.get(i).y * scale.y, 
                            userPath2.get(i+1).x * scale.x, userPath2.get(i+1).y * scale.y, 
                            linePaints.get(USER_PATH2_COLOR_INDEX));
        }
